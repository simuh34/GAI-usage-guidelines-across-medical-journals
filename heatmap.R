...
colnames(mat) = c('Usage permission','Language editing','Manuscript writing',
                  ...
                  'Fact-checking requirement','Usage documentation',
...
hm = Heatmap(
  ...
  column_names_gp = gpar(fontsize = 5.5,rot = 90),
  column_names_rot = 90,
...
print(hm)
#legend
lgd3 = Legend(labels = c('Yes','No','NR'), legend_gp = gpar(fill =  c('#2c7fb8','#e31a1c','#d9d9d9')),
